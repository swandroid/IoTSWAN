...
public class SwanExpressionLexer extends Lexer {
	...
	public final void mTIME_UNIT() throws RecognitionException {
		try {
			int _type = TIME_UNIT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:334:5: ( 'h' | 'H' | 'm' | 'M' | 's' | 'S' | 'ms' )
			int alt1=7;
			switch ( input.LA(1) ) {
			case 'h':
				{
			...
			switch (alt1) {
				case 1 :
					// SwanExpression.g:334:9: 'h'
					{
					match('h'); 
					}
					break;
				case 2 :
					// SwanExpression.g:334:13: 'H'
					{
					match('H'); 
					}
					break;
				case 3 :
					// SwanExpression.g:334:17: 'm'
					{
					match('m'); 
					}
					break;
				case 4 :
					// SwanExpression.g:334:21: 'M'
					{
					match('M'); 
					}
					break;
				case 5 :
					// SwanExpression.g:334:25: 's'
					{
					match('s'); 
					}
					break;
				case 6 :
					// SwanExpression.g:334:29: 'S'
					{
					match('S'); 
					}
					break;
				case 7 :
					// SwanExpression.g:334:33: 'ms'
					{
					match("ms"); 
	...
	public final void mAND() throws RecognitionException {
		try {
			int _type = AND;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:338:7: ( '&&' | 'and' | 'AND' )
			int alt3=3;
			switch ( input.LA(1) ) {
			case '&':
				{
	...
	public final void mNOT() throws RecognitionException {
		try {
			int _type = NOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:340:7: ( '!' | 'not' | 'NOT' )
			int alt4=3;
			switch ( input.LA(1) ) {
			case '!':
				{
			...
			switch (alt4) {
				case 1 :
					// SwanExpression.g:340:12: '!'
					{
					match('!'); 
					}
					break;
				case 2 :
					// SwanExpression.g:340:18: 'not'
					{
					match("not"); 
	...
	public final void mCONFIG_IS() throws RecognitionException {
		try {
			int _type = CONFIG_IS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:344:5: ( '=' )
			// SwanExpression.g:344:9: '='
			{
			match('='); 
			}
	...
	public final void mREGEX() throws RecognitionException {
		try {
			int _type = REGEX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:363:7: ( 'regex' | 'REGEX' )
			int alt7=2;
	...
	public final void mCONTAINS() throws RecognitionException {
		try {
			int _type = CONTAINS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:366:5: ( 'contains' | 'CONTAINS' )
			int alt8=2;
			...
			switch (alt8) {
				case 1 :
					// SwanExpression.g:366:10: 'contains'
					{
					match("contains"); 
					...
					break;
				case 2 :
					// SwanExpression.g:366:23: 'CONTAINS'
					{
					match("CONTAINS"); 
	...
	public final void mALL() throws RecognitionException {
		try {
			int _type = ALL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:369:9: ( ( 'ALL' | 'all' ) )
			// SwanExpression.g:369:13: ( 'ALL' | 'all' )
			{
			// SwanExpression.g:369:13: ( 'ALL' | 'all' )
			int alt9=2;
	...
	public final void mANY() throws RecognitionException {
		try {
			int _type = ANY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:370:5: ( ( 'ANY' | 'any' ) )
			// SwanExpression.g:370:9: ( 'ANY' | 'any' )
			{
			// SwanExpression.g:370:9: ( 'ANY' | 'any' )
			int alt10=2;
	...
	public final void mNONE() throws RecognitionException {
		try {
			int _type = NONE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:373:9: ( ( 'NONE' | 'none' ) )
			// SwanExpression.g:373:13: ( 'NONE' | 'none' )
			{
			// SwanExpression.g:373:13: ( 'NONE' | 'none' )
			int alt11=2;
	...
	public final void mMAX() throws RecognitionException {
		try {
			int _type = MAX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:374:5: ( ( 'MAX' | 'max' ) )
			// SwanExpression.g:374:9: ( 'MAX' | 'max' )
			{
			// SwanExpression.g:374:9: ( 'MAX' | 'max' )
			int alt12=2;
	...
	public final void mMIN() throws RecognitionException {
		try {
			int _type = MIN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:375:5: ( ( 'MIN' | 'min' ) )
			// SwanExpression.g:375:9: ( 'MIN' | 'min' )
			{
			// SwanExpression.g:375:9: ( 'MIN' | 'min' )
			int alt13=2;
	...
	public final void mMEAN() throws RecognitionException {
		try {
			int _type = MEAN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:376:9: ( ( 'MEAN' | 'mean' ) )
			// SwanExpression.g:376:13: ( 'MEAN' | 'mean' )
			{
			// SwanExpression.g:376:13: ( 'MEAN' | 'mean' )
			int alt14=2;
	...
	public final void mMEDIAN() throws RecognitionException {
		try {
			int _type = MEDIAN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:377:9: ( ( 'MEDIAN' | 'median' ) )
			// SwanExpression.g:377:13: ( 'MEDIAN' | 'median' )
			{
			// SwanExpression.g:377:13: ( 'MEDIAN' | 'median' )
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// SwanExpression.g:377:14: 'MEDIAN'
					{
					match("MEDIAN"); 
					...
					break;
				case 2 :
					// SwanExpression.g:377:23: 'median'
					{
					match("median"); 
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:379:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// SwanExpression.g:379:9: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// SwanExpression.g:379:33: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop16:
			while (true) {
				int alt16=2;
	...
	public final void mINT() throws RecognitionException {
		try {
			int _type = INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:382:5: ( ( '-' )? ( '0' .. '9' )+ )
			// SwanExpression.g:382:9: ( '-' )? ( '0' .. '9' )+
			{
			// SwanExpression.g:382:9: ( '-' )?
			int alt17=2;
	...
	public final void mFLOAT() throws RecognitionException {
		try {
			int _type = FLOAT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:386:5: ( ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '-' )? ( '0' .. '9' )+ EXPONENT )
			int alt28=3;
			alt28 = dfa28.predict(input);
			switch (alt28) {
				case 1 :
					// SwanExpression.g:386:9: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
					{
					// SwanExpression.g:386:9: ( '-' )?
					int alt19=2;
					...
					// SwanExpression.g:386:44: ( EXPONENT )?
					int alt22=2;
					...
					break;
				case 2 :
					// SwanExpression.g:387:9: ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )?
					{
					// SwanExpression.g:387:9: ( '-' )?
					int alt23=2;
					...
					// SwanExpression.g:387:32: ( EXPONENT )?
					int alt25=2;
					...
					break;
				case 3 :
					// SwanExpression.g:388:9: ( '-' )? ( '0' .. '9' )+ EXPONENT
					{
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:391:5: ( ( ' ' | '\\t' | '\\r' | '\\n' ) )
			// SwanExpression.g:391:9: ( ' ' | '\\t' | '\\r' | '\\n' )
			{
	...
	public final void mSTRING() throws RecognitionException {
		try {
			...
			// SwanExpression.g:400:5: ( '\\'' ( ESC_SEQ |normal=~ ( '\\'' | '\\\\' ) )* '\\'' )
			// SwanExpression.g:401:5: '\\'' ( ESC_SEQ |normal=~ ( '\\'' | '\\\\' ) )* '\\''
			{
			match('\''); 
			// SwanExpression.g:402:5: ( ESC_SEQ |normal=~ ( '\\'' | '\\\\' ) )*
			loop29:
			while (true) {
				int alt29=3;
				...
				switch (alt29) {
				case 1 :
					// SwanExpression.g:402:7: ESC_SEQ
					{
					mESC_SEQ(); 
	...
	public final void mESC_SEQ() throws RecognitionException {
		try {
			...
			// SwanExpression.g:414:5: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '/' | '\\\\' | ( 'u' )+ i= HEX_DIGIT j= HEX_DIGIT k= HEX_DIGIT l= HEX_DIGIT ) )
			// SwanExpression.g:414:9: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '/' | '\\\\' | ( 'u' )+ i= HEX_DIGIT j= HEX_DIGIT k= HEX_DIGIT l= HEX_DIGIT )
			{
			match('\\'); 
			// SwanExpression.g:415:9: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '/' | '\\\\' | ( 'u' )+ i= HEX_DIGIT j= HEX_DIGIT k= HEX_DIGIT l= HEX_DIGIT )
			int alt31=10;
			switch ( input.LA(1) ) {
			case 'n':
				{
			...
			switch (alt31) {
				...
				case 9 :
					...
					break;
				case 10 :
					// SwanExpression.g:424:17: ( 'u' )+ i= HEX_DIGIT j= HEX_DIGIT k= HEX_DIGIT l= HEX_DIGIT
					{
					// SwanExpression.g:424:17: ( 'u' )+
					int cnt30=0;
					loop30:
					while (true) {
						int alt30=2;
	...
	public final void mCONFIG_VAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:428:5: ( '=' ( STRING | ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' )* ) )
			// SwanExpression.g:428:9: '=' ( STRING | ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' )* )
			{
			match('='); 
			// SwanExpression.g:428:13: ( STRING | ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' )* )
			int alt33=2;
			...
			switch (alt33) {
				case 1 :
					// SwanExpression.g:428:14: STRING
					{
					mSTRING(); 
					...
					break;
				case 2 :
					// SwanExpression.g:433:11: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' )*
					{
					// SwanExpression.g:433:11: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' )*
					loop32:
					while (true) {
						...
						if ( (LA32_0=='&'||(LA32_0 >= '.' && LA32_0 <= ':')||LA32_0=='='||(LA32_0 >= 'A' && LA32_0 <= 'Z')||(LA32_0 >= 'a' && LA32_0 <= 'z')) ) {
							alt32=1;
						}
	...
	public final void mEXPONENT() throws RecognitionException {
		try {
			// SwanExpression.g:439:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
			// SwanExpression.g:439:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
			{
	...
	public final void mHEX_DIGIT() throws RecognitionException {
		try {
			// SwanExpression.g:442:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
			// SwanExpression.g:
			{
	...
	protected class DFA28 extends DFA {
		...
		public String getDescription() {
			return "385:1: FLOAT : ( ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '-' )? ( '0' .. '9' )+ EXPONENT );";
		}
	}
	...
	static final String DFA36_minS =
		...
		"\1\75\1\157\1\117\1\46\2\uffff\2\75\1\uffff\1\56\3\uffff\1\145\1\105\1"+
		"\157\1\117\1\uffff\1\56\5\uffff\1\60\1\170\1\156\1\141\1\130\1\116\1\101"+
		"\2\60\1\144\1\154\1\104\1\114\2\uffff\1\156\1\116\1\46\7\uffff\1\147\1"+
	...
	static final String[] DFA36_transitionS = {
			...
			"\1\76",
			"\1\77",
			"\2\102\6\uffff\15\102\2\uffff\1\100\3\uffff\32\102\6\uffff\32\102",
			"",
			"",
			"\1\103\1\74",
			"\1\105",
			...
			"\1\134\5\uffff\1\133",
			"\1\136\5\uffff\1\135",
			"\1\102\7\uffff\15\102\2\uffff\1\102\3\uffff\32\102\6\uffff\32\102",
			"",
			"",
			"",
			"",
